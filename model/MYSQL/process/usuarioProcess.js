        ...
        return new Promise(async(resolve,reject)=>{
            ...
            try {
                ...
                if(Object.keys(email).length!=0){
                    conexion.end();
                    return resolve({response:{code: 0, data: 'S/R', message: 'Este corre ya existe'},status:400})
                }
    ...
    loginUser(data){
        return new Promise(async(resolve,reject)=>{
            ...
            try {
                ...
                const accessToken=jwt.sign({data:data.correo}, process.env.SECRET, { expiresIn: '1m' });
